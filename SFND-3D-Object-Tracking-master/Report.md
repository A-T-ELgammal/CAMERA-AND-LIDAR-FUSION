...
![Final TTC estimation](output_images/ttc_estimation.png)
...
<img src="output_images/3d-objects_outliers-1.png" width="242" height="247" /><img src="output_images/lidar-topview_outliers-1.png" width="242" height="247" />

_Figure 2, far-side outlier_  
<img src="output_images/3d-objects_outliers-2.png" width="242" height="247" /><img src="output_images/lidar-topview_outliers-2.png" width="242" height="247" />

_Figure 3, multiple outliers_  
<img src="output_images/3d-objects_outliers-3.png" width="242" height="247" /><img src="output_images/lidar-topview_outliers-3.png" width="242" height="247" />

_Figure 4, a tight group without outliers_  
<img src="output_images/3d-objects_outliers-none.png" width="242" height="247" />

### FP.6 Performance evaluation, detector/descriptor combinations
Certain detector/descriptor combinations, especially the `Harris` and `ORB` detectors, produced very unreliable camera TTC estimates. Others, such as `SIFT`, `FAST`, and `AKAZE` detectors produced reliable output_images in line with the TTC estimates provided by the lidar sensor alone. Below is a sample of the output_images matrix, ranked by TTC estimate difference (between the camera and lidar systems).

![Selection from output_images matrix](output_images/output_images_csv.png)
